            ...
            <div style={cardStyle}>
                ...
                <form onSubmit={handleGuardar}>
                    ...
                    <div style={{ marginBottom: 14 }}>
                        <label htmlFor="texto_opcion" style={labelStyle}>¿Qué ve el lector?</label>
                        <input
                            id="texto_opcion" type="text" name="texto_opcion" value={form.texto_opcion}
                    ...
                    {/* Nodo origen */}
                    <div style={{ marginBottom: 14 }}>
                        <label htmlFor="id_nodo_origen" style={labelStyle}>¿En qué escena aparece?</label>
                        <select id="id_nodo_origen" name="id_nodo_origen" value={form.id_nodo_origen} onChange={handleChange} required disabled={guardando} style={selectStyle}>
                    ...
                    {/* Nodo destino */}
                    <div style={{ marginBottom: 14 }}>
                        <label htmlFor="id_nodo_destino" style={labelStyle}>¿A qué escena lleva?</label>
                        <select id="id_nodo_destino" name="id_nodo_destino" value={form.id_nodo_destino} onChange={handleChange} required disabled={guardando || !form.id_nodo_origen} style={selectStyle}>
                            <option value="">-- Selecciona la escena --</option>
                            {nodosDestino.map(n => (
        ...
        <Modal isOpen={!!modalEditar} onClose={() => !guardandoEdit && setModalEditar(null)} titulo="Editar decisión" ancho={500}>
            {modalEditar && (
                <form onSubmit={handleGuardarEdit}>
                    <div style={{ marginBottom: 14 }}>
                        <label htmlFor="edit_texto_opcion" style={labelStyle}>¿Qué ve el lector?</label>
                        <input
                            id="edit_texto_opcion" type="text" name="texto_opcion" value={formEditar.texto_opcion}
                    ...
                    <div style={{ marginBottom: 14 }}>
                        <label htmlFor="edit_id_nodo_origen" style={labelStyle}>¿En qué escena aparece?</label>
                        <select id="edit_id_nodo_origen" name="id_nodo_origen" value={formEditar.id_nodo_origen} onChange={handleChangeEdit} required disabled={guardandoEdit} style={selectStyle}>
                            <option value="">-- Selecciona la escena --</option>
                            {nodos.map(n => (
                    ...
                    <div style={{ marginBottom: 14 }}>
                        <label htmlFor="edit_id_nodo_destino" style={labelStyle}>¿A qué escena lleva?</label>
                        <select id="edit_id_nodo_destino" name="id_nodo_destino" value={formEditar.id_nodo_destino} onChange={handleChangeEdit} required disabled={guardandoEdit || !formEditar.id_nodo_origen} style={selectStyle}>
                            <option value="">-- Selecciona la escena --</option>
