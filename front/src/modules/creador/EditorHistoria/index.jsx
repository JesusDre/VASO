            ...
            <div style={{ background: 'var(--surface)', borderBottom: '1px solid var(--border)' }}>
                <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 1.5rem', display: 'flex', gap: 0, overflowX: 'auto' }}>
                    {TABS.map((t) => {
                        ...
                        let tabColor, badgeBg, badgeColor;
                        if (activo) { tabColor = 'var(--accent)'; badgeBg = 'var(--accent)'; badgeColor = '#fff'; }
                        else if (deshabilitado) { tabColor = '#c0cfe0'; badgeBg = '#e2e8f0'; badgeColor = '#b0bec5'; }
                        else { tabColor = 'var(--text-muted)'; badgeBg = 'var(--surface-2)'; badgeColor = 'var(--text-muted)'; }
                        return (
                            <button
                                key={t.key}
