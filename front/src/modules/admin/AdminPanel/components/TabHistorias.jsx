...
export default function TabHistorias() {
    ...
    let historiasContent;
    if (cargando) {
        historiasContent = <div style={{ textAlign: 'center', padding: '3rem 0' }}><Spinner /></div>;
    } else if (filtradas.length === 0) {
        historiasContent = <Empty texto="Sin historias en esta categoría." />;
    } else {
        historiasContent = (
